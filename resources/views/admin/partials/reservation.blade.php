            ...
            <div class="col-lg-10" data-aos="fade-up">
                ...
                <div
                    ...
                    <div class="table-responsive"
                        ...
                        <table class="table table-hover align-middle mb-0" style="min-width: 600px; width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        ...
                                        <i class="fas fa-circle me-1" style="font-size: 0.5rem; color: #3d195a;"></i>
                                        Premier League
                                    </td>
                                    <td class="text-end"
                                        style="padding: 15px; font-weight: 700; color: #222; border-bottom: 1px solid #eee;">
                                        Manchester United</td>
                                    <td class="text-center" style="padding: 15px; border-bottom: 1px solid #eee;"><span
                                ...
                                <tr>
                                    <td
                                        ...
                                        <i class="fas fa-circle me-1" style="font-size: 0.5rem; color: #e21a22;"></i> La
                                        Liga Spanyol
                                    </td>
                                    <td class="text-end"
                                        style="padding: 15px; font-weight: 700; color: #222; border-bottom: 1px solid #eee;">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <i class="fas fa-circle me-1" style="font-size: 0.5rem; color: #e8281a;"></i>
                                        Liga 1 Indonesia
                                    </td>
                                    <td class="text-end"
